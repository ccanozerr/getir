...
public class BookTest {
    ...
    public void it_should_convert_to_string_properly() {
        ...
        assertThat(bookStringValue).isEqualTo("Book{name='The Silmarillion', description='The Silmarillion is a collection of mythopoeic stories.', writer='J. R. R. Tolkien', price=15, remainingStock=10}");
