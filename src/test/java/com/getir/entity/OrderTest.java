...
public class OrderTest {
    ...
    public void it_should_convert_to_string_properly() {
        ...
        assertThat(orderStringValue).isEqualTo("Order{totalPrice=15, dateCreated=Sun Jul 07 00:00:00 TRT 3895, bookList=[Book{name='The Silmarillion', description='The Silmarillion is a collection of mythopoeic stories.', writer='J. R. R. Tolkien', price=15, remainingStock=10}]}");
