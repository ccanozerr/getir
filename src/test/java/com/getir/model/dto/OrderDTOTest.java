...
public class OrderDTOTest {
    ...
    public void it_should_convert_to_string_properly() {
        ...
        assertThat(orderStringValue).isEqualTo("OrderDTO{id=1, customerId=1, totalPrice=15, dateCreated=Sun Jul 07 00:00:00 TRT 3895, bookList=[BookDTO{id=1, name='The Silmarillion', description='The Silmarillion is a collection of mythopoeic stories.', writer='J. R. R. Tolkien', price=15.0, remainingStock=10}], totalBookCount=null}");
    }
}
